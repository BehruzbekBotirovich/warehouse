<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.25rem" viewBox="0 0 1024 1024">
        <path fill="oklch(0.852 0.199 91.936)" fillOpacity=".15"
            d="m512.5 190.4l-94.4 191.3l-211.2 30.7l152.8 149l-36.1 210.3l188.9-99.3l188.9 99.2l-36.1-210.3l152.8-148.9l-211.2-30.7z">
        </path>
        <path fill="oklch(0.769 0.188 70.08)"
